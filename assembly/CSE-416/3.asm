...
section .data                      ;Section containing data
        ...
        msg1: db "Enter characters(Maximum 15): ", 10  ; Prompt message
        msg1Len equ $-msg1           ; Count Length of msg1
        
        msg2: db "You entered "     ; Output msg
        msg2Len equ $-msg2          ; Count length of msg2

        msg3: db "First character is "     ; Output msg
        msg3Len equ $-msg3          ; Count length of msg3
...
_start:                            ;entry point for linker
        ...
        mov ebx, 2
        mov ecx, char
        mov edx, 15                 ; 15 bytes of that info
        int 80h
        ...
        mov edx, 15                 ; Pass the length of char 
        int 80h                    ; Make kernel call
        ...
        mov eax, 4                 ; initialize wr sys_call
        mov ebx, 1                 ;
        mov ecx, msg3              ; Pass offset of the msg
        mov edx, msg3Len           ; Pass the length of msg 
        int 80h                    ; Make kernel call
