...
public class WelcomeWindow extends JFrame {
	...
	private UserFileOperation getVoter = new UserFileOperation("Voters");
	protected int mode;
	...
	public WelcomeWindow() {
		...
		btnClickHereTo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(!getTextArea().getText().toString().isEmpty() && !getVoter.getUserData().isEmpty() && (radioButton2.isSelected() || radioButton3.isSelected() || radioButton4.isSelected() || radioButton5.isSelected()) )
				{
				...
				if( mode == 2 )
				{
					if( getVoter.getUserData().isEmpty() )
					{
