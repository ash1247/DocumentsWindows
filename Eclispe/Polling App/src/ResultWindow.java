...
public class ResultWindow extends JFrame {
	...
	private UserFileOperation result = new UserFileOperation();
	...
	public ResultWindow() {
		...
		vote.count1Percentage();
		vote.count2Percentage();
		vote.count3Percentage();
		vote.count5Percentage();
		vote.count5Percentage();
		...
		String dat = al.get( 1 );
		String opt = al.get( 2 );
		String vters = al.get( 3 );
		String per = al.get( 4 );
		
		data.insertDataVoteLog(dat, mod, top, opt, vters, per);
		...
		String s1 = data.getTopicAndOption( 1 );
		
		String s2 = data.getTopicAndOption( 2 );
		
		String s3 = data.getTopicAndOption( 3 );
		
		String s4 = data.getTopicAndOption( 4 );
		
		String s5 = data.getTopicAndOption( 5 );
		
		JLabel lblOption1Des = new JLabel("<html>Option 1 which was ' " + s1 + "', <br>Got " 
											+ data.getOptionPercentage(1) + "% vote, "
											+ data.getOptionCount(1) + " voted in this option.</html>");
		
		lblOption1Des.setFont(new Font("Tahoma", Font.PLAIN, 17));
		
		JLabel lblOption2Des = new JLabel("<html>Option 2 which was ' " + s2 + "', <br>Got " 
										+ data.getOptionPercentage(2) + "% vote, "
												+ data.getOptionCount(2) + " voted in this option.</html>");
		
		lblOption2Des.setFont(new Font("Tahoma", Font.PLAIN, 17));
		
		JLabel lblOption3Des = new JLabel("<html>Option 3 which was ' " + s3 + "', <br>Got " 
											+ data.getOptionPercentage(3) + "% vote, "
													+ data.getOptionCount(3) + " voted in this option.</html>");
		
		lblOption3Des.setFont(new Font("Tahoma", Font.PLAIN, 17));
		
		JLabel lblOption4Des = new JLabel("<html>Option 4 which was ' " + s4 + "', <br>Got " 
											+ data.getOptionPercentage(4) + "% vote, "
													+ data.getOptionCount(4) + " voted in this option.</html>");

		lblOption4Des.setFont(new Font("Tahoma", Font.PLAIN, 17));
		
		JLabel lblOption5Des = new JLabel("<html>Option 5 which was ' " + s5 + "', <br>Got " 
											+ data.getOptionPercentage(5) + "% vote, "
													+ data.getOptionCount(5) + " voted in this option.</html>");
		...
		JLabel lblTotalVotersWere = new JLabel("Total Voters were " + UserDataManipulations.getTotalCount() + ".");
		...
		String op1 = data.stringResizer( lblOption1Des.getText().toString() ) + "\n";
		String op2 = data.stringResizer( lblOption2Des.getText().toString() ) + "\n";
		String op3 = data.stringResizer( lblOption3Des.getText().toString() ) + "\n";
		String op4 = data.stringResizer( lblOption4Des.getText().toString() ) + "\n";
		String op5 = data.stringResizer( lblOption5Des.getText().toString() ) + "\n";
		String space = "\n\n\n\n";
